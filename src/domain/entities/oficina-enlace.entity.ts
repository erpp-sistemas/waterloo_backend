...
export class OficinaEnlaceEntity {
    ...
    static fromObject(object: { [key: string]: any }): OficinaEnlaceEntity {
        ...
        let {
            nombres, apellido_paterno, apellido_materno, calle, num_ext, num_int, colonia, codigo_postal,
        ...
        return new OficinaEnlaceEntity(nombres, apellido_paterno, apellido_materno, calle, num_ext, num_int,
